...
<div x-data="{ openModal: false, selectedPelanggaran: {} }">
    ...
    <div class="container mx-auto p-6">
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
            <h2 class="text-3xl font-bold text-gray-800 dark:text-white mb-6 text-center">📑 Data Pelanggaran</h2>

            {{-- Form Pencarian --}}
            
    <form method="GET" action="{{ route('pelanggaran.index') }}" class="mb-6 w-full sm:w-1/2" id="searchForm">
    <div class="relative">
        <!-- Search icon -->
    ...
    window.addEventListener('pageshow', () => {
        spinner.classList.add('hidden');
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 rounded-lg shadow-md text-xs">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700 text-gray-800 dark:text-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                            ...
                            <td class="px-4 py-2 text-[11px] leading-snug max-w-xs break-words">{{ $allKeterangan ?: '-' }}</td>
                            <td class="px-4 py-2 text-[11px] leading-snug max-w-xs break-words">{{ $allTindakan ?: '-' }}</td>
