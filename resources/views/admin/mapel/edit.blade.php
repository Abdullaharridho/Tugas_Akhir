...
<body>
    <div class="bg-white p-6 rounded shadow">
        <h2 class="text-2xl font-bold mb-4">Edit Matapelajaran</h2>
        ...
        <form action="{{ route('mapel.update', $matapelajaran) }}" method="POST">
            ...
            <label class="block">
                ...
                <input type="text" name="nama" value="{{ $matapelajaran->nama }}" class="block w-full mt-1 p-2 border rounded" required>
            </label>
