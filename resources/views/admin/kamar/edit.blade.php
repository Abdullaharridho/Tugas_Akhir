    ...
    <div class="bg-white p-6 rounded shadow">
        ...
        <form action="{{ route('kamar.update', $kamar) }}" method="POST">
            ...
            <label class="block">
                ...
                <input type="text" name="nama" value="{{ $kamar->nama }}" class="block w-full mt-1 p-2 border rounded" required>
            </label>

            <button type="submit" class="mt-4 bg-blue-500 text-white px-4 py-2 rounded">Update</button>
            <a href="{{ route('kamar.index') }}" class="mt-4 bg-gray-500 text-white px-4 py-2 rounded">Kembali</a>
        </form>
